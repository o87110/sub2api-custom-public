...
func ProvideSystemHandler(updateService *customupdater.UpdateService, lockService *service.SystemOperationLockService) *admin.SystemHandler {
...
var ProviderSet = wire.NewSet(
	...
	admin.ProvideSubscriptionHandler,
