...
type UpdateSettingsRequest struct {
	...
	SubscriptionRebateEnabled                 *bool                             `json:"affiliate_subscription_rebate_enabled"`
	...
	PaymentChannelSettings           *paymentchannels.ChannelSettings `json:"payment_channel_settings"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		SubscriptionRebateEnabled:              boolValueOrDefault(req.SubscriptionRebateEnabled, previousSettings.SubscriptionRebateEnabled),
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			ChannelSettings:               req.PaymentChannelSettings,
	...
	payload := dto.SystemSettings{
		...
		SubscriptionRebateEnabled:                              updatedSettings.SubscriptionRebateEnabled,
		...
		PaymentChannelSettings:                                 updatedPaymentCfg.ChannelSettings,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentRechargeFeeRate != nil || req.PaymentChannelSettings != nil ||
