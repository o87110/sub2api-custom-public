...
type channelMonitorCreateRequest struct {
	...
	GroupRateOverride        *float64          `json:"group_rate_override"`
	GroupRateDisplayTemplate string            `json:"group_rate_display_template" binding:"max=64"`
...
type channelMonitorUpdateRequest struct {
	...
	GroupRateOverride        *float64           `json:"group_rate_override"`
	ClearGroupRateOverride   bool               `json:"clear_group_rate_override"`
	GroupRateDisplayTemplate *string            `json:"group_rate_display_template" binding:"omitempty,max=64"`
	Enabled                  *bool              `json:"enabled"`
...
type channelMonitorResponse struct {
	...
	GroupRateOverride        *float64                             `json:"group_rate_override"`
	GroupRateDisplayTemplate string                               `json:"group_rate_display_template"`
	Enabled                  bool                                 `json:"enabled"`
...
func channelMonitorToResponse(m *service.ChannelMonitor) *channelMonitorResponse {
	...
	resp := &channelMonitorResponse{
		...
		GroupRateOverride:        m.GroupRateOverride,
		GroupRateDisplayTemplate: m.GroupRateDisplayTemplate,
		Enabled:                  m.Enabled,
...
func (h *ChannelMonitorHandler) Create(c *gin.Context) {
	...
	m, err := h.monitorService.Create(c.Request.Context(), service.ChannelMonitorCreateParams{
		...
		GroupRateOverride:        req.GroupRateOverride,
		GroupRateDisplayTemplate: req.GroupRateDisplayTemplate,
		Enabled:                  enabled,
...
func (h *ChannelMonitorHandler) Update(c *gin.Context) {
	...
	m, err := h.monitorService.Update(c.Request.Context(), id, service.ChannelMonitorUpdateParams{
		...
		GroupName:                req.GroupName,
		GroupRateOverride:        req.GroupRateOverride,
		ClearGroupRateOverride:   req.ClearGroupRateOverride,
		GroupRateDisplayTemplate: req.GroupRateDisplayTemplate,
		Enabled:                  req.Enabled,
		IntervalSeconds:          req.IntervalSeconds,
		JitterSeconds:            req.JitterSeconds,
