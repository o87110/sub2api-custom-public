...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.GET("/bulk-reset-quota/candidates", h.Admin.Subscription.ListBulkResetQuotaCandidates)
		...
		subscriptions.PUT("/:id/current-cycle-bulk-reset-eligibility", h.Admin.Subscription.UpdateCurrentCycleBulkResetEligibility)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	affiliates := admin.Group("/affiliates")
	{
		...
		affiliates.GET("/rebates", h.Admin.AffiliateReversal.ListRebateRecords)
		affiliates.POST("/rebates/reversal-preview", h.Admin.AffiliateReversal.Preview)
		affiliates.POST("/rebates/reverse", h.Admin.AffiliateReversal.Reverse)
