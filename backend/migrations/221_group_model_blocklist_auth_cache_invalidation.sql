-- Forward fix for already-installed 193: include models_list_config in the
-- durable auth-cache invalidation trigger's UPDATE no-op comparison.
-- This only replaces the function body; no schema or data changes are made.
