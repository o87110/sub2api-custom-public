...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	baseUserSubscriptionRepository := repository.NewUserSubscriptionRepository(client)
	subscriptionrepositoryRepository := subscriptionrepository.New(client, baseUserSubscriptionRepository)
	...
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, subscriptionrepositoryRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository)
	apiKeyCache := repository.NewAPIKeyCache(redisClient)
	concurrencyCache := repository.ProvideConcurrencyCache(redisClient, configConfig)
	schedulerCache := repository.ProvideSchedulerCache(redisClient, configConfig)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache)
	concurrencyService := service.ProvideConcurrencyService(concurrencyCache, accountRepository, configConfig)
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, subscriptionrepositoryRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService)
	apiKeyAuthCacheInvalidator := service.ProvideAPIKeyAuthCacheInvalidator(apiKeyService)
	promoService := service.NewPromoService(promoCodeRepository, userRepository, billingCacheService, client, apiKeyAuthCacheInvalidator)
	subscriptionService := service.NewSubscriptionService(groupRepository, subscriptionrepositoryRepository, billingCacheService, client, configConfig)
	...
	announcementService := service.NewAnnouncementService(announcementRepository, announcementReadRepository, userRepository, subscriptionrepositoryRepository)
	...
	subscriptionbulkresetService := subscriptionbulkreset.NewService(client, subscriptionService)
	adminSubscriptionHandler := admin.ProvideSubscriptionHandler(subscriptionService, subscriptionbulkresetService)
	...
	affiliatereversalService := affiliatereversal.NewService(client, apiKeyAuthCacheInvalidator, billingCacheService)
	affiliatereversalHandler := affiliatereversal.NewHandler(affiliatereversalService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, affiliatereversalHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService)
	...
	codexVersionSyncLifecycle := updater.ProvideCodexVersionSyncLifecycle(settingRepository, settingService, configConfig)
	gitHubReleaseClient := updater.NewVersionInfoClient(configConfig)
	...
	subscriptionExpiryService := service.ProvideSubscriptionExpiryService(subscriptionrepositoryRepository, settingRepository, notificationEmailService, leaderLockCache, db)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, codexVersionSyncLifecycle, claudeCodeVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService, auditLogService, openAIQuotaAutoResetService, promptService, pluginManager)
	...
	application := provideApplication(httpServer, promptService, v, contentModerationService, violationCounter, channelMonitorUserHandler, groupRateResolver, pluginManager)
...
func provideCleanup(
	...
	codexVersionSync *updater.CodexVersionSyncLifecycle,
