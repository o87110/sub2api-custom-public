...
type GroupEdges struct {
	...
	// OrderedAPIKeys holds the value of the ordered_api_keys edge.
	OrderedAPIKeys []*APIKey `json:"ordered_api_keys,omitempty"`
...
// OrderedAPIKeysOrErr returns the OrderedAPIKeys value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) OrderedAPIKeysOrErr() ([]*APIKey, error) {
	if e.loadedTypes[1] {
		return e.OrderedAPIKeys, nil
	}
	return nil, &NotLoadedError{edge: "ordered_api_keys"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldRateMultiplier, group.FieldMinimumBalance, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldMinimumBalance:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
...
// QueryOrderedAPIKeys queries the "ordered_api_keys" edge of the Group entity.
func (_m *Group) QueryOrderedAPIKeys() *APIKeyQuery {
	return NewGroupClient(_m.config).QueryOrderedAPIKeys(_m)
}
