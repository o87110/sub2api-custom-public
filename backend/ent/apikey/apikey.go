...
func newGroupLinksStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(GroupLinksInverseTable, GroupLinksColumn),
