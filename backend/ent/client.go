...
// QueryGroupLinks queries the group_links edge of a APIKey.
func (c *APIKeyClient) QueryGroupLinks(_m *APIKey) *APIKeyGroupQuery {
...
// QueryOrderedAPIKeys queries the ordered_api_keys edge of a Group.
func (c *GroupClient) QueryOrderedAPIKeys(_m *Group) *APIKeyQuery {
	query := (&APIKeyClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
