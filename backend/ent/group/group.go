...
const (
	...
	// EdgeOrderedAPIKeys holds the string denoting the ordered_api_keys edge name in mutations.
	EdgeOrderedAPIKeys = "ordered_api_keys"
	...
	// OrderedAPIKeysTable is the table that holds the ordered_api_keys relation/edge. The primary key declared below.
	OrderedAPIKeysTable = "api_key_groups"
	// OrderedAPIKeysInverseTable is the table name for the APIKey entity.
	// It exists in this package in order to avoid circular dependency with the "apikey" package.
	OrderedAPIKeysInverseTable = "api_keys"
...
var (
	// OrderedAPIKeysPrimaryKey and OrderedAPIKeysColumn2 are the table columns denoting the
	// primary key for the ordered_api_keys relation (M2M).
	OrderedAPIKeysPrimaryKey = []string{"api_key_id", "group_id"}
...
// ByOrderedAPIKeysCount orders the results by ordered_api_keys count.
func ByOrderedAPIKeysCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newOrderedAPIKeysStep(), opts...)
	}
}

// ByOrderedAPIKeys orders the results by ordered_api_keys terms.
func ByOrderedAPIKeys(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newOrderedAPIKeysStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newOrderedAPIKeysStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(OrderedAPIKeysInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.M2M, true, OrderedAPIKeysTable, OrderedAPIKeysPrimaryKey...),
	)
}
