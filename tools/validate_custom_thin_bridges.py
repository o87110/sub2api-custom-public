...
APPROVED_DELEGATE_VIEW_CALL_DELTAS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    'backend/internal/service/content_moderation.go': _approved_call_deltas(
        ...
        ('UpdateConfig', {'normalizeContentModerationAPIAuditScope': 1}),
        ('applyFlaggedAccountSideEffects', {'s.countFlaggedByUserSince': 1}),
        ('cloneContentModerationConfig', {'normalizeContentModerationAPIAuditScope': 1}),
        ('configView', {'normalizeContentModerationAPIAuditScope': 1}),
        ('defaultContentModerationConfig', {'defaultContentModerationAPIAuditScope': 1}),
        ('normalize', {'normalizeContentModerationAPIAuditScope': 1}),
        ('validateConfig', {
            'err.Error': 1,
            'fmt.Sprintf': 1,
