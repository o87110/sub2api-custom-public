...
grep -Fqx $'backend/internal/service/content_moderation.go\tbackend/internal/custom/moderation/api_audit_scope.go|backend/internal/custom/moderation/cyber_policy.go|backend/internal/custom/moderation/excerpt.go|backend/internal/custom/moderation/user_ban_threshold.go' "$shadow_map"
...
grep -Fqx $'backend/internal/service/content_moderation_test.go\tbackend/internal/custom/moderation/api_audit_scope_test.go|backend/internal/custom/moderation/excerpt_test.go|backend/internal/custom/moderation/user_ban_threshold_test.go|backend/internal/service/custom_moderation_bridge_test.go' "$shadow_map"
