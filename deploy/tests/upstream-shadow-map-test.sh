...
if [[ "$expected_count" -eq 175 ]]; then
  ...
  assert_mapping $'backend/internal/service/content_moderation.go\tbackend/internal/custom/moderation/api_audit_ban.go|backend/internal/custom/moderation/api_audit_scope.go|backend/internal/custom/moderation/cyber_policy.go|backend/internal/custom/moderation/excerpt.go|backend/internal/custom/moderation/group_scope_reconcile.go|backend/internal/custom/moderation/user_ban_threshold.go'
