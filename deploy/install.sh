...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/o87110/sub2api-custom-public/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="o87110/sub2api-custom-public"
...
Documentation=https://github.com/o87110/sub2api-custom-public
