    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          subscriptionRebate: '订阅参与返利',
          subscriptionRebateHint: '开启后，被邀请用户购买订阅会产生邀请返利；关闭后仅停止后续订阅订单返利，余额充值和已有返利不受影响。',
          rebateRate: '全局返利比例',
      ...
      payment: {
        ...
        rechargeFeeRate: '默认支付手续费率',
        rechargeFeeRateHint: '余额充值和订阅购买默认收取的手续费；用户渠道可单独覆盖，0 表示默认免手续费',
        rechargeFeePreview: '预览：支付 100 元，手续费 {fee} 元',
        orderTimeout: '订单超时时间',
        ...
        validationEasyPayCustomMethodReserved: '易支付自定义支付方式不能使用内置的 alipay、wxpay、stripe、card 或 link',
        ...
        field_apiToken: 'BEpusdt API 对接令牌',
        ...
        easypayProtocol: '协议',
        easypayProtocolRainbow: 'Rainbow EasyPay 兼容模式',
        easypayProtocolBepusdt: 'BEpusdt 原生 API',
        bepusdtNetworks: 'USDT 网络',
        bepusdtNetworksHint: '选择要展示给用户的 USDT 网络；默认优先使用 BEP20。',
        validationBepusdtTokenRequired: 'BEpusdt 原生模式必须填写 API 对接令牌',
        validationBepusdtNetworkRequired: 'BEpusdt 原生模式至少选择一个 USDT 网络',
        validationBepusdtMode: 'BEpusdt 原生模式固定使用弹窗支付且不支持退款',
        ...
        providerName: '服务商名称',
        providerNameHint: '仅供管理员识别，不展示给用户',
        providerKey: '服务商类型',
