export default {
  ...
  subscriptionProgress: {
    ...
    weekly: 'Weekly',
    monthly: 'Monthly',
    cycleStats: 'Current cycle total ${usage} · Resets {count}',
  ...
  payment: {
    ...
    errors: {
      ...
      switchChannelHint: 'You can manually switch to “{channel}” and retry. No backup-channel order will be created automatically.',
      ...
      PLAN_RENEWAL_GRACE_INVALID: 'Expiry grace days must be an integer between 0 and 30.',
      ...
      ORDER_ALREADY_PAID: 'The order has already been paid and cannot be cancelled. Please wait for completion.',
      PAYMENT_STATUS_UNAVAILABLE: 'The payment provider status is temporarily unavailable. Please try again later.',
      ORDER_STATUS_CHANGED: 'The order status changed. Refresh and try again.',
    ...
    admin: {
      ...
      remainingQuantitySoldOutHint: 'This plan is sold out. Enter a positive quantity to restock it, or clear the field for unlimited sales.',
      remainingQuantityInvalid: 'Remaining quantity must be blank or a positive integer.',
      remainingQuantityInvalidAllowZero: 'Remaining quantity must be blank or a non-negative integer.',
      inventoryUnlimited: 'Unlimited',
      inventorySoldOut: '0 / Sold out',
      inventoryAutoDelisted: 'Auto-delisted',
      inventoryPurchaseDisabled: 'Purchasing disabled',
      soldOutAction: 'Sold-out Action',
      soldOutActionDelist: 'Auto-delist',
      soldOutActionDisablePurchase: 'Keep visible and disable purchase',
      soldOutActionHint: 'Auto-delist is the default. New users cannot buy visible sold-out plans; eligible existing users may still renew when the plan policy allows it.',
      soldOutCannotList: 'This auto-delist plan is sold out. Restock it, make it unlimited, or switch to disabled purchasing before listing it.',
      renewalPolicy: 'Existing-user Renewal',
      allowExistingUserRenewal: 'Allow Existing Users to Renew',
      allowExistingUserRenewalHint: 'When enabled, users with an active subscription in the same group, or one still within its expiry grace period, may renew delisted or sold-out plans without consuming remaining quantity.',
      renewalGraceDays: 'Expiry Grace Days',
      renewalGraceDaysHint: 'Enter 0–30 days. Zero disables renewal after expiry; active subscriptions are unaffected.',
      renewalGraceDaysInvalid: 'Expiry grace days must be an integer between 0 and 30.',
      renewalEnabled: 'Renewal allowed',
      renewalDisabled: 'Disabled',
      renewalGraceDaysValue: 'Within {days} days after expiry',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
      groupId: 'Group ID',
