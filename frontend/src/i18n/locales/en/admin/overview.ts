export default {
    ...
    affiliates: {
      ...
      reversal: {
        action: 'Reverse Rebates',
        selected: '{count} orders selected',
        selectedAmount: '${amount} in rebates',
        clearSelection: 'Clear selection',
        selectOrder: 'Select order #{order}',
        statusColumn: 'Rebate Status',
        statusFilter: 'Filter by rebate status',
        statusAll: 'All Rebates',
        statusActive: 'Active',
        statusReversed: 'Reversed',
        deductionSummary: 'Frozen ${frozen} / available ${quota} / balance ${balance}',
        snapshotUnavailable: 'Historical manual reversal; financial snapshot unavailable',
        reversedBy: 'Admin #{user}',
        dialogTitle: 'Confirm Rebate Reversal',
        previewLoading: 'Calculating frozen quota, available rebate, and balance impact…',
        previewFailed: 'Unable to prepare the rebate reversal preview',
        orderCount: 'Orders',
        totalAmount: 'Total Rebate Reversal',
        frozenDeducted: 'Frozen Deduction',
        quotaDeducted: 'Available Deduction',
        balanceDeducted: 'Balance Deduction',
        balanceAfter: 'Balance After',
        negativeWarning: 'This reversal will leave {count} inviter accounts with a negative balance',
        negativeHint: 'A negative balance blocks balance-billed requests but does not cancel an active subscription. Future top-ups offset the deficit first.',
        confirmNegative: 'I confirm that the inviter balances may become negative',
        reasonLabel: 'Reversal Reason',
        reasonPlaceholder: 'Enter a reason suitable for the audit trail',
        irreversibleHint: 'This cannot be restored. The payment orders and payment records remain unchanged.',
        confirmAction: 'Reverse All Selected',
        submitting: 'Reversing…',
        submitFailed: 'Rebate reversal failed; no partial changes were committed',
        success: 'Reversed rebates for {count} orders, totaling ${amount}',
        errors: {
          AFFILIATE_REVERSAL_INVALID_ORDERS: 'Select between 1 and 100 valid rebate orders.',
          AFFILIATE_REVERSAL_INVALID_REASON: 'Enter a reversal reason of no more than 500 characters.',
          AFFILIATE_REVERSAL_TARGET_INVALID: 'A selected rebate changed, was already reversed, or no longer exists. Refresh and try again.',
          AFFILIATE_REVERSAL_PREVIEW_STALE: 'The financial state changed. Prepare a new reversal preview.',
          AFFILIATE_REVERSAL_NEGATIVE_BALANCE_CONFIRM_REQUIRED: 'This reversal creates a negative balance. Confirm the risk first.',
          AFFILIATE_REVERSAL_INVARIANT: 'Affiliate financial totals are inconsistent. The batch was rolled back for manual review.'
        }
      }
    },
    ...
    groups: {
      ...
      form: {
        ...
        minimumBalance: 'Minimum available balance threshold',
        minimumBalanceHint: 'A user balance must be strictly greater than this amount to bind or use the group. A balance equal to the threshold has no usable amount. Set to 0 to disable.',
        minimumBalanceInvalid: 'The minimum available balance threshold must be a valid amount greater than or equal to 0',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
