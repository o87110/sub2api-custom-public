export default {
    ...
    subscriptions: {
      ...
      bulkReset: {
        ...
        selectSubscription: 'Select the {plan} subscription for {email}',
        user: 'User',
        plan: 'Plan',
        ...
        emptyHint: 'Enable “Allow Bulk Quota Reset” when editing a subscription plan. Only active paid subscriptions whose effective cycle can be traced to an enabled plan are listed.',
        requested: 'Requested',
        success: 'Success',
        skipped: 'Skipped',
        failed: 'Failed',
        ...
        noLongerEligible: 'Subscription status or plan eligibility changed, so this item was safely skipped',
