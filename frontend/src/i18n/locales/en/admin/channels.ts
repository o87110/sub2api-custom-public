export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        groupNamePlaceholder: 'Custom group label on the user monitor card (optional)',
        groupNameHint: 'Shown after the model on user monitor cards and searchable in admin. It is never replaced by the rate.',
        groupRateOverride: 'Manual rate override',
    ...
    subscriptions: {
      ...
      manualEligibility: {
        action: 'Bulk Reset Eligibility',
        actionEnabled: 'Eligibility On',
        actionDisabled: 'Eligibility Off',
        assignLabel: 'Allow Bulk Quota Reset',
        assignHint: 'Controls only the subscription cycle created by this manual assignment. It is off by default and can be changed later from the subscription actions.',
        title: 'Change Bulk Reset Eligibility',
        enable: 'Enable Eligibility',
        disable: 'Disable Eligibility',
        enableConfirm: "Enable bulk reset eligibility for '{user}' on the current manual subscription cycle? Usage and validity will not change.",
        disableConfirm: "Disable bulk reset eligibility for '{user}' on the current manual subscription cycle? Usage and validity will not change.",
        enabledSuccess: 'Bulk reset eligibility enabled for the current cycle',
        disabledSuccess: 'Bulk reset eligibility disabled for the current cycle',
        updateFailed: 'Failed to update bulk reset eligibility'
      },
      bulkReset: {
        action: 'Bulk Reset Quota',
        title: 'Bulk Reset Usage Quotas',
        loading: 'Loading eligible subscriptions…',
        loadFailed: 'Failed to load eligible subscriptions. Please try again.',
        retry: 'Reload',
        summary: '{users} users and {subscriptions} active subscriptions',
        selected: '{count} subscriptions selected',
        selectionLimit: 'To keep results safely replayable, each batch can include up to {count} subscriptions. Reset the remaining candidates in another batch.',
        selectAll: 'Select all eligible subscriptions',
        selectSubscription: 'Select the {source} subscription for {email}',
        user: 'User',
        source: 'Subscription Source',
        manualSource: 'Manual assignment · {group}',
        cycleUsage: 'Cycle Usage',
        resetCount: 'Reset Count',
        warning: 'This will clear the current daily, weekly, and monthly usage for each selected subscription. Cycle totals and usage history will be retained.',
        submit: 'Reset {count} Selected Subscriptions',
        submitting: 'Resetting…',
        submitFailed: 'The result of this bulk operation could not be confirmed. The selection is locked so it can be safely retried with the same idempotency key.',
        retrySubmit: 'Retry This Reset',
        emptyTitle: 'No subscriptions are eligible for bulk reset',
        emptyHint: 'Paid subscriptions require “Allow Bulk Quota Reset” on their plan. Active manual or legacy subscriptions require eligibility on their current cycle.',
        requested: 'Requested',
        success: 'Success',
        skipped: 'Skipped',
        failed: 'Failed',
        status: 'Result',
        reason: 'Details',
        completedReason: 'Current daily, weekly, and monthly usage was reset',
        noLongerEligible: 'Subscription status, source, or bulk reset eligibility changed, so this item was safely skipped',
        resetFailedReason: 'The quota reset failed. Please try again later',
        requestFailedReason: 'The bulk request failed. Please try again later'
      },
