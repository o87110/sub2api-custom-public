export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        groupName: 'Fallback group label',
        groupNamePlaceholder: 'Shown when no local group can be resolved (optional)',
        groupNameHint: 'For a local API key, channel monitoring shows the key’s current default group rate automatically. This label is used only when no local group can be resolved.',
