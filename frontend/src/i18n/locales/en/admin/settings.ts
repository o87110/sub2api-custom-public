    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          subscriptionRebate: 'Rebate Subscription Purchases',
          subscriptionRebateHint: 'When enabled, invitees purchasing subscriptions generate affiliate rebates. When disabled, only future subscription orders are skipped; balance recharges and existing rebates are unaffected.',
      ...
      payment: {
        ...
        rechargeFeeRate: 'Default Payment Fee Rate',
        rechargeFeeRateHint: 'Default fee for balance recharges and subscriptions. User channels can override it; 0 means no default fee',
        rechargeFeePreview: 'Preview: Pay 100, fee {fee}',
        ...
        validationEasyPayCustomMethodReserved: 'Custom EasyPay payment types cannot use built-in alipay, wxpay, stripe, card, or link',
        ...
        field_apiToken: 'BEpusdt API Token',
        ...
        easypayProtocol: 'Protocol',
        easypayProtocolRainbow: 'Rainbow EasyPay compatibility',
        easypayProtocolBepusdt: 'BEpusdt native API',
        bepusdtNetworks: 'USDT networks',
        bepusdtNetworksHint: 'Choose the USDT networks shown to users; BEP20 is preferred by default.',
        validationBepusdtTokenRequired: 'BEpusdt native mode requires an API token',
        validationBepusdtNetworkRequired: 'Select at least one USDT network for BEpusdt native mode',
        validationBepusdtMode: 'BEpusdt native mode requires popup payment and does not support refunds',
        ...
        providerName: 'Provider Name',
        providerNameHint: 'For administrator identification only; never shown to users',
